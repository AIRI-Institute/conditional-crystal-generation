...
from py_utils.crystal_dataset import CrystalDataset
...
class PairDataset:
    ...
    def __getitem__(self, index):
        ...
        x1 = self.dataset.__getitem__(x1_index, x0["shuffle_order"])
        result = {
...
def get_balanced_dataloaders_pairs(
    ...
    random_shuffle_coordinates=False,
):
    """
    ...
    for dataframe, df_type, avg_pairs in zip(
        ...
        dataset = CrystalDataset(
            ...
            random_shuffle_coordinates=(
                random_shuffle_coordinates if df_type == "train" else False
            ),
        )
